...
.DESCRIPTION
	Windows autopilot company cûstomization bootstrap
.FUNCTIONALITY
	Activate numLock on Windows start
	Configure background
	Remove unwanted software
	Don't let Edge create a desktop shortcut
	Customize default apps
	Install FR-CH, GE-DE and En-GB languages
	Local and international Settings
	Set registered user and organization
	Disable IPv6 on all cards in the list
	Create a Windows Firewall for MS Teams
	Remove FAX
	WinRM OpenEye Config
#>

############################################################################################
#
# LOADING INTIAL PARAMETERS FOR THE SCRIPT
