...
Copy-Item -Path "$($PSScriptRoot)\Autopilot.jpg" -Destination "C:\Windows\Web\Wallpaper" -Force
...
reg.exe add "$($userRegPath)\Microsoft\Windows\CurrentVersion\Policies\System" /v "Wallpaper" /t REG_SZ /d "C:\Windows\Web\Wallpaper\Autopilot.jpg" /f | Out-Host
